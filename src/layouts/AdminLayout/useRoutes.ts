...
const UserPage = lazy(() => delayLazyLoad(import('pages/UserPage')));
const StatisticPage = lazy(() => delayLazyLoad(import('pages/StatisticPage')));
...
const routes: AppRouteType[] = [
  ...
  {
    path: routesMap.STATISTIC,
    component: StatisticPage,
    rule: -1,
    openKey: [],
    activeKey: [routesMap.STATISTIC],
  },
];
